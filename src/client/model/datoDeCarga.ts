...
/**
 * Clase que describe al dato de carga
 */
export interface DatoDeCarga { 
    /**
     * Caudal del dato de carga
     */
    caudal: number;
    /**
     * Densidad del dato de carga
     */
    densidad: number;
    /**
     * Fecha / hora en la que se guardó el dato
     */
    estampaTiempo?: Date;
    id?: number;
    /**
     * Masa acumulada del dato de carga
     */
    masaAcumulada: number;
    /**
     * Temperatura del dato de carga
     */
    temperatura: number;
}
