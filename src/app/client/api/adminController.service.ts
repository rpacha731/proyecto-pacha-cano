...
export class AdminControllerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public enableUserUsingPUT(id: number, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public enableUserUsingPUT(id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public enableUserUsingPUT(id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public enableUserUsingPUT(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listarRolesUsingGET(observe?: 'body', reportProgress?: boolean): Observable<any>;
    public listarRolesUsingGET(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public listarRolesUsingGET(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public listarRolesUsingGET(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
